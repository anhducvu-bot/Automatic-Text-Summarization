...
class TransformerDecoderLayer(nn.Module):
    ...
    def __init__(self, d_model, heads, d_ff, dropout):
        ...
        self.w_bias = nn.Parameter(torch.rand(10,d_model)) #AV Added
    ...
    def forward(self, inputs, memory_bank, src_pad_mask, tgt_pad_mask,
        ...
        mid = self.context_attn(memory_bank, memory_bank, query_norm,
                                      ...
                                      layer_cache=layer_cache,
                                      type="context")
        print("This is mid shape:", mid.shape)
        print("This is d_model:", self.d_model)
        print(mid[:,:,1].shape)
        #AV Added
        theta = torch.ones(10,1)
        z = torch.matmul(torch.transpose(theta,0,1),self.w_bias)
        mid = mid + z
        #print(z.shape)
        #mid[...,1] = mid[...,1]+z
        #AV Added
